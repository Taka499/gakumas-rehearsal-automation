...
- [ ] Final acceptance (manual, needs the interactive desktop): run `GAKUMAS_NO_MANIFEST=1 cargo test clipboard_roundtrip -- --ignored` from a normal terminal; click-through both surfaces per Validation and Acceptance, including the failure toast.
