...
Source: backfill audit 2026-07-06 over all 23 ExecPlans. The superseding decision has no recorded provenance; rationale inferred from CLAUDE.md and code.

Accepted 2026-07-06: the user confirmed the inferred rationale — full-image OCR picked up too much noise, hindering OCR accuracy at the time.
